...
class CycleISPRgb2Raw(object):
    """Thin wrapper around CycleISP Rgb2Raw without modifying CycleISP source."""
    ...
    def _install_gaussian_blur_shim(self) -> None:
        ...
        if spec is None or spec.loader is None:
            raise ImportError("Cannot load CycleISP GaussianBlur from {}".format(gaussian_path))
